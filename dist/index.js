...
async function getFiles(options) {
    if (options.glob === 'true') {
        ...
        return [path_1.posix.join(parsedSource.dir, parsedSource.base)];
    }
}
...
async function run() {
    try {
        ...
        await (0, ftp_1.default)({ user, password, host, port, secure, src, glob, dest });
...
const taskManager = __webpack_require__(882);
